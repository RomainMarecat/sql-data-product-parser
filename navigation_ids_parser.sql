	SELECT IF(n6.id is not null AND n6.lvl>0, n6.id, NULL) AS navigation_ids
	FROM category AS c1 
	...
	LEFT JOIN navigation AS n1 ON n1.id = nc1.navigation_id
	LEFT JOIN navigation AS n2 ON n2.id = n1.parent_id 
	LEFT JOIN navigation AS n3 ON n3.id = n2.parent_id
	LEFT JOIN navigation AS n4 ON n4.id = n3.parent_id
	LEFT JOIN navigation AS n5 ON n5.id = n4.parent_id
	LEFT JOIN navigation AS n6 ON n6.id = n5.parent_id
	WHERE c1.id = IF('${product.product_category_id}', '${product.product_category_id}', 1) 	
	AND n6.id IS NOT NULL AND n6.lvl > 0
UNION ALL 
	SELECT IF(n5.id is not null AND n5.lvl>0, n5.id, NULL) AS navigation_ids
	FROM category AS c1 
	LEFT JOIN category AS c2 ON c2.id = c1.parent_id 
	LEFT JOIN category AS c3 ON c3.id = c2.parent_id
	LEFT JOIN category AS c4 ON c4.id = c3.parent_id
...
UNION ALL 
	SELECT IF(n4.id is not null AND n4.lvl>0, n4.id, NULL) AS navigation_ids
	FROM category AS c1 
	LEFT JOIN category AS c2 ON c2.id = c1.parent_id 
	LEFT JOIN category AS c3 ON c3.id = c2.parent_id
	LEFT JOIN category AS c4 ON c4.id = c3.parent_id
...
UNION ALL 
	SELECT IF(n3.id is not null AND n3.lvl>0, n3.id, NULL) AS navigation_ids
	FROM category AS c1 
	LEFT JOIN category AS c2 ON c2.id = c1.parent_id 
	LEFT JOIN category AS c3 ON c3.id = c2.parent_id
	LEFT JOIN category AS c4 ON c4.id = c3.parent_id
...
UNION ALL 
	SELECT IF(n2.id is not null AND n2.lvl>0, n2.id, NULL) AS navigation_ids
	FROM category AS c1 
	LEFT JOIN category AS c2 ON c2.id = c1.parent_id 
	LEFT JOIN category AS c3 ON c3.id = c2.parent_id
	LEFT JOIN category AS c4 ON c4.id = c3.parent_id
...
UNION ALL 
	SELECT IF(n1.id is not null AND n1.lvl>0, n1.id, NULL) AS navigation_ids
	FROM category AS c1 
	LEFT JOIN category AS c2 ON c2.id = c1.parent_id 
	LEFT JOIN category AS c3 ON c3.id = c2.parent_id
	LEFT JOIN category AS c4 ON c4.id = c3.parent_id
